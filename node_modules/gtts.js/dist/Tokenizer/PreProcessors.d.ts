 ...
 * @returns {string}
 */
export declare function toneMarks(text: string): string;
/**
 ...
 * @returns {string}
 */
export declare function endOfLine(text: string): string;
/**
 ...
 * @returns {string}
 */
export declare function abbreviations(text: string): string;
/**
 ...
 * @returns {string}
 */
export declare function wordSub(text: string): string;
